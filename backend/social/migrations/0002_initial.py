...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='reciever',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reciever_user', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='threadmodel',
            name='user',
        ...
        migrations.AddField(
            model_name='message',
            name='reciever_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gets', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='message',
            name='sender_user',
